...
public:
	...
	static CCScale9SpriteEx* spriteWithFile(const char* file,ccScale9Mode mode=eScale9Strach, const CCRect* rect=NULL, const CCRect* capInsets = NULL);
	void setContentSize(const CCSize &size);
	virtual void setIsOpacityModifyRGB(bool bValue);
	virtual bool getIsOpacityModifyRGB(){return bIsOpacityModifyRGB_;}
